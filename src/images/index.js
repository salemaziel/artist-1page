...
//export const FullLogo1_jpg = require('./Logo.jpg');
//export const LogoWords1_png = require('./logo-1-words.png');
//export const LogoHelmet1_jpg = require('./logo-1-cropped.jpg');
//export const FullLogo2_jpg = require('./Spartan-Logo.jpg');
