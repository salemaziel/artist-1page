  ...
  <div className="wrapper">
    <div className="profile-card js-profile-card">
      <div className="profile-card__img">
        <img src="https://www.salemaziel.com/static/me-striped-shirt-585x780-91fac4c7cb96c060cc75ebca1c853991.jpg" alt="profile card" />
      </div>
      <div className="profile-card__cnt js-profile-cnt">
        <div className="profile-card__name">Salem Aziel</div>
        <div className="profile-card__txt">Web Developer &amp; Digital Consultant <strong></strong></div>
        ...
        <div className="profile-card-social">
          <a href={data.siteYaml.facebook_link} className="profile-card-social__item facebook" target="_blank">
          ...
          <a href={data.siteYaml.instagram_link} className="profile-card-social__item instagram" target="_blank">
            <span className="icon-font">
